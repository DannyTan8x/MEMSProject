...
import model.view.ProductsInventory;
 ...
 public class ProductListTableModelForSales extends AbstractTableModel {
	
	private static final long serialVersionUID = 1L;
	List<ProductsInventory> productInv;
//	 private final String[] columnNames = {"產品類別ID", "產品類別", "產品ID", "品名", "入庫數量", "銷售數量", "目前庫存"};
	 private final String[] columnNames = {"產品類別ID", "產品類別", "產品ID", "品名",  "目前庫存", "售價"};

	public ProductListTableModelForSales(List<ProductsInventory> productInv) {
		super();
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case 5: return product.getProductPrice();
