...
public class ProductListTableModelForInventory extends AbstractTableModel {
...
//	 private final String[] columnNames = {"產品類別ID", "產品類別", "產品ID", "品名",  "目前庫存"};
	...
	public ProductListTableModelForInventory(List<ProductsInventory> productInv) {
		super();
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case 4: return product.getPurchaseAmount();
		case 5: return product.getSalesAmount();
		case 6: return product.getInventoryAmount();
